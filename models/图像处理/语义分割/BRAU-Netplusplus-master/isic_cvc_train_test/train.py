...
def train_model(model, criterion, optimizer, scheduler, num_epochs=5):
    ...
    print('Best val losses: {:4f}'.format(best_loss))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--csvfile', type=str, default='src/test_train_data.csv',
                        help='two columns [image_id,category(train/maskovrd)]')
    parser.add_argument('--losses', default='dice', help='losses type')
