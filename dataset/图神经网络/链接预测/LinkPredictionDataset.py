...
class LinkPredictionDataset(Dataset):
    ...
    def process(self):
        ...
        for raw_path in self.raw_paths:
            ...
            edge_label = data['edge_label']  # 边标签 (num_edges,)

            graph_data = Data(x=x, edge_index=edge_index, edge_label=edge_label)
...
if __name__ == "__main__":
    # 数据集根目录
    root = "E:/Github_Project/troch_GUI/dataset/图像处理/链接预测"
    ...
    print("Edge labels:", sample.edge_label)
    ...
    for batch in dataloader:
        ...
        print("Batch edge labels:", batch.edge_label)