...
"""
Hausdorff losses implementation based on paper:
...
class HausdorffDTLoss(nn.Module):
    """Binary Hausdorff losses based on distance transform"""
...
class HausdorffERLoss(nn.Module):
    """Binary Hausdorff losses based on morphological erosion"""
    ...
    def perform_erosion(
        ...
        for batch in range(len(bound)):
            ...
            for k in range(self.erosions):
                ...
                # save erosion and add to losses
                bound[batch] = erosion
